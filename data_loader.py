...
if __name__ == "__main__":
    '''
    python data_loader.py --patch_size 128 128 128 --data_dir /mnt/hdd/sda/ygeo/tmp_kits23/stage0/ --batch_size 4
    '''
   
    
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument("--patch_size_zxy",  nargs="+", help="List of spacings in [z,x,y] directions", type = int, default = [128,128,128])
    parser.add_argument("--data_dir",  type=str, default = "/mnt/hdd/sda/ygeo/tmp_kits23/stage0/", help="directory forresampled and normalized directory")
    parser.add_argument("--batch_size", type = int, default = 4, help="Batch size")
    parser.add_argument("--num_threads", type = int, default = 8, help="Batch size")
    ...
    patch_size = args.patch_size_zxy #
    batch_size = args.batch_size
    
    dataset = load_dataset(data_dir)
    unpack_dataset(data_dir, threads = default_num_threads)
    ...
    for x in tr:
        ...
        if i > 225:
            break
    plt.savefig("sample_images_dl.png", bbox_inches='tight', pad_inches=0)
